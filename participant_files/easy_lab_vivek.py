''' 
1. The onlyOneRightAnswer() function returns Hmm... let's try that again!, when. input to the question and correctAnswer does not match.
2. 10 times.
3. total to be intialized with 1 but not 0 and the if num < 0 should be num > 0.
4.We just need to give input any character other than 'n'. 
5. It will run forever as num does not change.
'''
